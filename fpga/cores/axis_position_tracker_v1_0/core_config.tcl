...
core_parameter S_AXIS_TDATA_WIDTH {Slave AXIS TDATA WIDTH}  {Width of the AXI stream data port.}
core_parameter M_AXIS_TDATA_WIDTH {Master AXIS TDATA WIDTH} {Width of the AXI stream data port.}

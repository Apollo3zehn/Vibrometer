...
#
# Generated by Vivado on Fri Dec 21 10:00:09 +0100 2018
...
if { [get_files sign_finder.v] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/wilvin/Desktop/Git/Vibrometer/fpga/Vibrometer/sign_finder.v
}
...
# module references:
# extremum_finder, frequency_counter, sign_finder, signal_splitter
...
proc create_hier_cell_Averager { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type clk log_count_extremum
  create_bd_pin -dir I -from 4 -to 0 log_count_sign
  create_bd_pin -dir I -type clk log_shift_extremum
  ...
  # Create port connections
  connect_bd_net -net SF_log_count_0_1 [get_bd_pins log_count_sign] [get_bd_pins sign_finder/SF_log_count]
  connect_bd_net -net SYS_aclk_0_1 [get_bd_pins aclk] [get_bd_pins axi_bram_reader_0/aclk] [get_bd_pins extremum_finder/SYS_aclk] [get_bd_pins position_tracker/SYS_aclk] [get_bd_pins sign_finder/SYS_aclk]
  connect_bd_net -net SYS_aresetn_0_1 [get_bd_pins aresetn] [get_bd_pins axi_bram_reader_0/aresetn] [get_bd_pins extremum_finder/SYS_aresetn] [get_bd_pins position_tracker/SYS_aresetn] [get_bd_pins sign_finder/SYS_aresetn]
  ...
  connect_bd_net -net log_count_1 [get_bd_pins log_count_extremum] [get_bd_pins extremum_finder/EF_log_count]
  connect_bd_net -net log_shift_1 [get_bd_pins log_shift_extremum] [get_bd_pins extremum_finder/EF_log_shift]
...
preplace port log_shift_extremum -pg 1 -y 50 -defaultsOSRD
preplace port log_count_extremum -pg 1 -y 30 -defaultsOSRD
...
preplace portBus log_count_sign -pg 1 -y 110 -defaultsOSRD
preplace inst sign_finder -pg 1 -lvl 3 -y -80 -defaultsOSRD
preplace inst position_tracker -pg 1 -lvl 2 -y -110 -defaultsOSRD
preplace inst blk_mem_gen_0 -pg 1 -lvl 2 -y 230 -defaultsOSRD
preplace inst axi_bram_reader_0 -pg 1 -lvl 1 -y 240 -defaultsOSRD
preplace inst extremum_finder -pg 1 -lvl 1 -y 10 -defaultsOSRD
preplace netloc extremum_finder_0_EF_upper_treshold 1 1 1 190
preplace netloc Conn2 1 0 1 NJ
preplace netloc sign_finder_0_SF_sign 1 1 3 200 -240 NJ -240 1270
preplace netloc SYS_aresetn_0_1 1 0 3 -350 -90 160 -230 750
preplace netloc extremum_finder_0_EF_lower_treshold 1 1 1 200
preplace netloc axi_bram_reader_0_BRAM_PORTA 1 1 1 N
preplace netloc log_shift_1 1 0 1 N
preplace netloc S_AXIS_data_1 1 0 1 N
preplace netloc log_count_1 1 0 1 N
preplace netloc SYS_aclk_0_1 1 0 3 -360 -100 170 -220 740
preplace netloc SF_log_count_0_1 1 0 3 NJ 110 NJ 110 740J
preplace netloc position_tracker_0_M_AXIS 1 2 1 N
preplace netloc extremum_finder_0_M_AXIS 1 1 1 180
levelinfo -pg 1 -380 -20 580 1120 1290 -top -380 -bot 900
"
}
...
preplace netloc clk_wiz_0_clk_out1 1 1 2 260 410 N
...
levelinfo -pg 1 -30 130 460 862 1362 1642 1780 -top -100 -bot 950
"
}

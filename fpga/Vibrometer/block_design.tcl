...
#
# Generated by Vivado on Sun Jan 27 21:33:38 +0100 2019
...
#    "C:/Users/Vincent/Desktop/Git/Vibrometer/fpga/Vibrometer/sim/averager_tb.sv"
#    "C:/Users/Vincent/Desktop/Git/Vibrometer/fpga/Vibrometer/sim/averager_tb.wcfg"
#
#*****************************************************************************************
...
set_property -name "webtalk.activehdl_export_sim" -value "139" -objects $obj
set_property -name "webtalk.ies_export_sim" -value "140" -objects $obj
set_property -name "webtalk.modelsim_export_sim" -value "140" -objects $obj
set_property -name "webtalk.questa_export_sim" -value "140" -objects $obj
set_property -name "webtalk.riviera_export_sim" -value "139" -objects $obj
set_property -name "webtalk.vcs_export_sim" -value "139" -objects $obj
set_property -name "webtalk.xsim_export_sim" -value "140" -objects $obj
set_property -name "webtalk.xsim_launch_sim" -value "449" -objects $obj
...
# Create 'averager' fileset (if not found)
if {[string equal [get_filesets -quiet averager] ""]} {
  create_fileset -simset averager
}

# Set 'averager' fileset object
set obj [get_filesets averager]
set files [list \
 [file normalize "${origin_dir}/sim/averager_tb.sv"] \
 [file normalize "${origin_dir}/sim/averager_tb.wcfg"] \
]
add_files -norecurse -fileset $obj $files

# Set 'averager' fileset file properties for remote files
set file "$origin_dir/sim/averager_tb.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets averager] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj


# Set 'averager' fileset file properties for local files
# None

# Set 'averager' fileset properties
set obj [get_filesets averager]
set_property -name "top" -value "averager_tb" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "top_lib" -value "xil_defaultlib" -objects $obj
...
proc create_hier_cell_GPIO_config_1 { parentCell nameHier } {
  ...
  # Perform GUI Layout
  regenerate_bd_layout -hierarchy [get_bd_cells /Processing/Fourier_Transform/GPIO_config] -layout_string {
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 6.8.11  2018-08-07 bk=1.4403 VDI=40 GEI=35 GUI=JA:9.0 non-TLS
#  -string -flagsOSRD
preplace port aresetn -pg 1 -y 120 -defaultsOSRD
preplace portBus log_count -pg 1 -y 180 -defaultsOSRD
preplace portBus log_throttle -pg 1 -y 280 -defaultsOSRD
preplace portBus aresetn_o -pg 1 -y 70 -defaultsOSRD
preplace portBus data -pg 1 -y 140 -defaultsOSRD
preplace inst enable -pg 1 -lvl 1 -y 60 -defaultsOSRD
preplace inst log_count -pg 1 -lvl 2 -y 180 -defaultsOSRD
preplace inst log_throttle -pg 1 -lvl 2 -y 280 -defaultsOSRD
preplace inst and_gate -pg 1 -lvl 2 -y 70 -defaultsOSRD
preplace netloc throttle_Dout 1 2 1 NJ
preplace netloc and_gate_Res 1 2 1 NJ
preplace netloc axi_gpio_0_gpio_io_o 1 0 2 20 140 220
preplace netloc aresetn_1 1 0 2 NJ 120 220J
preplace netloc log_length_Dout 1 2 1 NJ
preplace netloc enable_Dout 1 1 1 NJ
levelinfo -pg 1 0 120 370 540 -top 0 -bot 340
"
}
...
proc create_hier_cell_Fourier_Transform { parentCell nameHier } {
  ...
  # Create instance: BRAM_real, and set properties
  set BRAM_real [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 BRAM_real ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net axis_complex_averager_BRAM_PORTA [get_bd_intf_pins BRAM_real/BRAM_PORTA] [get_bd_intf_pins axis_complex_averager/BRAM_PORTA]
  connect_bd_intf_net -intf_net axis_complex_averager_BRAM_PORTB [get_bd_intf_pins BRAM_real/BRAM_PORTB] [get_bd_intf_pins axis_complex_averager/BRAM_PORTB]
...
preplace port M_AXIS_fft -pg 1 -y 300 -defaultsOSRD
preplace port aclk -pg 1 -y 170 -defaultsOSRD
preplace port aresetn -pg 1 -y 90 -defaultsOSRD
preplace port S_AXI_cfg -pg 1 -y 150 -defaultsOSRD
preplace inst axis_complex_data -pg 1 -lvl 3 -y 300 -defaultsOSRD
preplace inst real_to_complex -pg 1 -lvl 4 -y 310 -defaultsOSRD
preplace inst xfft -pg 1 -lvl 5 -y 340 -defaultsOSRD
preplace inst GPIO_config -pg 1 -lvl 2 -y 150 -defaultsOSRD
preplace inst axis_throttler -pg 1 -lvl 3 -y 100 -defaultsOSRD
preplace inst complex_data -pg 1 -lvl 2 -y 310 -defaultsOSRD
preplace inst forward_FFT -pg 1 -lvl 3 -y 480 -defaultsOSRD
preplace inst axi_gpio -pg 1 -lvl 1 -y 170 -defaultsOSRD
preplace inst BRAM_real -pg 1 -lvl 7 -y 370 -defaultsOSRD
preplace inst axis_complex_averager -pg 1 -lvl 6 -y 320 -defaultsOSRD
preplace inst fft_settings -pg 1 -lvl 4 -y 470 -defaultsOSRD
preplace netloc Conn1 1 0 1 NJ
preplace netloc axis_throttler_M_AXIS 1 3 1 810
preplace netloc axis_constant_0_M_AXIS1 1 3 1 N
preplace netloc xlconstant_0_dout1 1 2 1 NJ
preplace netloc axis_complex_averager_BRAM_PORTA 1 6 1 1850
preplace netloc axis_constant_0_M_AXIS 1 4 1 1150
preplace netloc axis_complex_averager_BRAM_PORTB 1 6 1 1840
preplace netloc GPIO_config_log_throttle 1 2 1 550
...
preplace netloc data_1 1 1 1 300
preplace netloc aresetn_1 1 0 2 NJ 90 300J
preplace netloc axis_combiner_0_M_AXIS1 1 4 1 N
preplace netloc aclk_0_1 1 0 6 20 250 NJ 250 560 230 800 400 1160 470 1520J
preplace netloc axis_complex_averager_M_AXIS 1 6 2 NJ 300 NJ
preplace netloc GPIO_config_log_count 1 2 4 540 540 NJ 540 NJ 540 1540J
preplace netloc GPIO_config_aresetn_o 1 2 4 540 10 820 220 1140 480 1530J
levelinfo -pg 1 0 160 420 680 980 1340 1690 1950 2070 -top 0 -bot 550
"
}
...
proc create_hier_cell_RAM_Writer { parentCell nameHier } {
  ...
  connect_bd_net -net sync_manager_0_SM_read_buffer [get_bd_pins axi_gpio/gpio2_io_i] [get_bd_pins sync_manager/SM_read_buffer]
...
proc create_hier_cell_Processing { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net Filter_M_AXIS_filtered [get_bd_intf_pins Filter/M_AXIS_filter] [get_bd_intf_pins Fourier_Transform/S_AXIS_filter]
  ...
  connect_bd_intf_net -intf_net S_AXIS_position_2 [get_bd_intf_pins Filter/S_AXIS_position] [get_bd_intf_pins Position_Tracker/M_AXIS_position]
...
preplace netloc Filter_M_AXIS_filtered 1 1 1 380
preplace netloc PS7_M03_AXI 1 0 2 NJ 330 NJ
preplace netloc axis_red_pitaya_adc_0_adc_csn 1 1 2 NJ 450 NJ
preplace netloc S_AXIS_position_2 1 0 3 40 250 NJ 250 710
...
preplace port S_AXI_position -pg 1 -y 70 -defaultsOSRD
...
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 2 340 240 810
preplace netloc Conn6 1 3 1 NJ
preplace netloc Conn7 1 3 1 NJ
preplace netloc rst_ps7_0_50M_interconnect_aresetn 1 0 3 20 250 NJ 250 830
preplace netloc Conn8 1 3 1 NJ
preplace netloc S00_AXI_1 1 2 1 820
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 0 4 30 260 NJ 260 840 610 NJ
preplace netloc Net 1 0 3 10 10 330 230 820
preplace netloc dcm_locked_0_1 1 0 2 NJ 410 NJ
preplace netloc axi_interconnect_HP_M00_AXI 1 1 1 N
levelinfo -pg 1 -10 180 580 990 1160 -top 0 -bot 630
"
}
...
proc create_hier_cell_AXIS_Switch { parentCell nameHier } {
  ...
  set filter [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_dwidth_converter:1.1 filter ]
  set_property -dict [ list \
   CONFIG.M_TDATA_NUM_BYTES {4} \
 ] $filter

  # Create instance: position, and set properties
  set position [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_dwidth_converter:1.1 position ]
  set_property -dict [ list \
   CONFIG.M_TDATA_NUM_BYTES {4} \
 ] $position
  ...
  connect_bd_intf_net -intf_net S_AXIS_filtered_1 [get_bd_intf_pins S_AXIS_filter] [get_bd_intf_pins filter/S_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_dwidth_converter_0_M_AXIS [get_bd_intf_pins axis_switch/S01_AXIS] [get_bd_intf_pins position/M_AXIS]
  connect_bd_intf_net -intf_net position1_M_AXIS [get_bd_intf_pins axis_switch/S02_AXIS] [get_bd_intf_pins filter/M_AXIS]
  ...
  connect_bd_net -net aresetn_0_1 [get_bd_pins aresetn] [get_bd_pins axis_switch/aresetn] [get_bd_pins axis_switch/s_axi_ctrl_aresetn] [get_bd_pins filter/aresetn] [get_bd_pins position/aresetn]
...
# Proc to create BD averager
proc cr_bd_averager { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name averager
  ...
  # Create ports
  set AV_log_count [ create_bd_port -dir I -from 4 -to 0 AV_log_count ]
  set aclk [ create_bd_port -dir I -type clk aclk ]
  set aresetn [ create_bd_port -dir I -type rst aresetn ]

  # Create instance: axis_complex_averager_0, and set properties
  set axis_complex_averager_0 [ create_bd_cell -type ip -vlnv Apollo3zehn:user:axis_complex_averager:1.0 axis_complex_averager_0 ]
  set_property -dict [ list \
   CONFIG.BRAM_ADDR_WIDTH {3} \
   CONFIG.BRAM_DATA_WIDTH {64} \
 ] $axis_complex_averager_0
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S_AXIS_0_1 [get_bd_intf_ports S_AXIS] [get_bd_intf_pins axis_complex_averager_0/S_AXIS]
  connect_bd_intf_net -intf_net axis_complex_averager_0_BRAM_PORTA [get_bd_intf_pins axis_complex_averager_0/BRAM_PORTA] [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTA]
  connect_bd_intf_net -intf_net axis_complex_averager_0_BRAM_PORTB [get_bd_intf_pins axis_complex_averager_0/BRAM_PORTB] [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTB]
  connect_bd_intf_net -intf_net axis_complex_averager_0_M_AXIS [get_bd_intf_ports M_AXIS] [get_bd_intf_pins axis_complex_averager_0/M_AXIS]

  # Create port connections
  connect_bd_net -net AV_log_count_1 [get_bd_ports AV_log_count] [get_bd_pins axis_complex_averager_0/AV_log_count]
  connect_bd_net -net aclk_1 [get_bd_ports aclk] [get_bd_pins axis_complex_averager_0/aclk]
  connect_bd_net -net aresetn_1 [get_bd_ports aresetn] [get_bd_pins axis_complex_averager_0/aresetn]
...
# End of cr_bd_averager()
cr_bd_averager ""
set_property REGISTERED_WITH_MANAGER "1" [get_files averager.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files averager.bd ] 

...
#
# Generated by Vivado on Tue Jan 22 09:53:01 +0100 2019
...
#
#    "C:/Users/wilvin/Desktop/Git/Vibrometer/fpga/Vibrometer/axis_sniffer.v"
#    "C:/Users/wilvin/Desktop/Git/Vibrometer/fpga/Vibrometer/signal_switch.v"
...
#    "C:/Users/wilvin/Desktop/Git/Vibrometer/fpga/Vibrometer/axis_throttler.v"
#    "C:/Users/wilvin/Desktop/Git/Vibrometer/fpga/Vibrometer/s2mm_ram_writer.v"
#    "C:/Users/wilvin/Desktop/Git/Vibrometer/fpga/Vibrometer/sync_manager.v"
#    "C:/Users/wilvin/Desktop/Git/Vibrometer/fpga/Vibrometer/differentiator.v"
...
#    "C:/Users/wilvin/Desktop/Git/Vibrometer/fpga/Vibrometer/sim/extremum_finder_tb.sv"
#    "C:/Users/wilvin/Desktop/Git/Vibrometer/fpga/Vibrometer/sim/extremum_finder_tb.wcfg"
#    "C:/Users/wilvin/Desktop/Git/Vibrometer/fpga/Vibrometer/sim/position_tracker_tb.sv"
#    "C:/Users/wilvin/Desktop/Git/Vibrometer/fpga/Vibrometer/sim/position_tracker_tb.wcfg"
...
#    "C:/Users/wilvin/Desktop/Git/Vibrometer/fpga/Vibrometer/sim/signal_switch_tb.sv"
#    "C:/Users/wilvin/Desktop/Git/Vibrometer/fpga/Vibrometer/sim/signal_switch_tb.wcfg"
#    "C:/Users/wilvin/Desktop/Git/Vibrometer/fpga/Vibrometer/sim/axis_throttler_tb.sv"
#    "C:/Users/wilvin/Desktop/Git/Vibrometer/fpga/Vibrometer/sim/axis_throttler_tb.wcfg"
#    "C:/Users/wilvin/Desktop/Git/Vibrometer/fpga/Vibrometer/sim/differentiator_tb.sv"
#    "C:/Users/wilvin/Desktop/Git/Vibrometer/fpga/Vibrometer/sim/differentiator_tb.wcfg"
#
#*****************************************************************************************
...
set_property -name "webtalk.xsim_launch_sim" -value "385" -objects $obj
...
set files [list \
 ...
 [file normalize "${origin_dir}/differentiator.v"] \
...
# Create 'differentiator' fileset (if not found)
if {[string equal [get_filesets -quiet differentiator] ""]} {
  create_fileset -simset differentiator
}

# Set 'differentiator' fileset object
set obj [get_filesets differentiator]
set files [list \
 [file normalize "${origin_dir}/sim/differentiator_tb.sv"] \
 [file normalize "${origin_dir}/sim/differentiator_tb.wcfg"] \
]
add_files -norecurse -fileset $obj $files

# Set 'differentiator' fileset file properties for remote files
set file "$origin_dir/sim/differentiator_tb.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets differentiator] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj


# Set 'differentiator' fileset file properties for local files
# None

# Set 'differentiator' fileset properties
set obj [get_filesets differentiator]
set_property -name "top" -value "differentiator_tb" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "top_lib" -value "xil_defaultlib" -objects $obj
...
if { [get_files axis_sniffer.v] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/wilvin/Desktop/Git/Vibrometer/fpga/Vibrometer/axis_sniffer.v
}
if { [get_files signal_switch.v] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/wilvin/Desktop/Git/Vibrometer/fpga/Vibrometer/signal_switch.v
}
if { [get_files axis_sniffer.v] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/wilvin/Desktop/Git/Vibrometer/fpga/Vibrometer/axis_sniffer.v
}
...
if { [get_files axis_throttler.v] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/wilvin/Desktop/Git/Vibrometer/fpga/Vibrometer/axis_throttler.v
}
if { [get_files s2mm_ram_writer.v] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/wilvin/Desktop/Git/Vibrometer/fpga/Vibrometer/s2mm_ram_writer.v
}
...
if { [get_files differentiator.v] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/wilvin/Desktop/Git/Vibrometer/fpga/Vibrometer/differentiator.v
}
if { [get_files axis_throttler.v] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/wilvin/Desktop/Git/Vibrometer/fpga/Vibrometer/axis_throttler.v
}
...
# module references:
# axis_throttler, s2mm_ram_writer, sync_manager, axis_sniffer, signal_switch, axis_sniffer, axis_throttler, differentiator, axis_throttler, axis_sniffer, axis_sniffer, extremum_finder, position_tracker
...
proc create_hier_cell_Position_Tracker { parentCell nameHier } {
  ...
  connect_bd_net -net log_scale_Dout [get_bd_pins log_scale/Dout] [get_bd_pins position_tracker/FC_log_scale]
...
proc create_hier_cell_Fourier_Transform { parentCell nameHier } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S_AXIS_filtered_1 [get_bd_intf_pins S_AXIS_filtered] [get_bd_intf_pins axis_throttler/S_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_throttler_M_AXIS [get_bd_intf_pins axis_throttler/M_AXIS] [get_bd_intf_pins xfft/S_AXIS_DATA]
  connect_bd_intf_net -intf_net xfft_M_AXIS_DATA [get_bd_intf_pins M_AXIS_fft] [get_bd_intf_pins xfft/M_AXIS_DATA]

  # Create port connections
  connect_bd_net -net aclk_0_1 [get_bd_pins aclk] [get_bd_pins axis_constant/aclk] [get_bd_pins axis_throttler/aclk] [get_bd_pins xfft/aclk]
  connect_bd_net -net aresetn_1_1 [get_bd_pins aresetn] [get_bd_pins axis_throttler/aresetn]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axis_constant/cfg_data] [get_bd_pins xlconstant/dout]
...
proc create_hier_cell_Filter { parentCell nameHier } {
  ...
  # Create instance: differentiator, and set properties
  set block_name differentiator
  set block_cell_name differentiator
  if { [catch {set differentiator [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $differentiator eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net axis_throttler_M_AXIS [get_bd_intf_pins axis_throttler/M_AXIS] [get_bd_intf_pins differentiator/S_AXIS]
  connect_bd_intf_net -intf_net differentiator_M_AXIS [get_bd_intf_pins axis_sniffer/S_AXIS] [get_bd_intf_pins differentiator/M_AXIS]

  # Create port connections
  connect_bd_net -net Net [get_bd_pins axi_gpio/gpio_io_i] [get_bd_pins axi_gpio/gpio_io_o] [get_bd_pins log_throttle/Din]
  connect_bd_net -net aclk_1 [get_bd_pins aclk] [get_bd_pins axi_gpio/s_axi_aclk] [get_bd_pins axis_sniffer/aclk] [get_bd_pins axis_throttler/aclk] [get_bd_pins differentiator/aclk]
  connect_bd_net -net aresetn_0_1 [get_bd_pins aresetn] [get_bd_pins axi_gpio/s_axi_aresetn] [get_bd_pins axis_throttler/aresetn] [get_bd_pins differentiator/aresetn]
...
preplace port M_AXIS_filtered -pg 1 -y 130 -defaultsOSRD
...
preplace port M_AXIS_filtered_dbg -pg 1 -y 150 -defaultsOSRD
...
preplace netloc clk_wiz_0_clk_out1 1 0 2 20 240 410
...
preplace netloc Data_Aquisition_M_AXIS_raw 1 1 1 400
preplace netloc S00_ARESETN_1 1 0 2 30 230 390
